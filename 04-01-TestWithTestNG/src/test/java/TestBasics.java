...
public class TestBasics {
    ...
    public void getCategories(){
        ...
        Reporter.log("Test 1 - get categories of product.");
       ...
       // String endpoint = "http://localhost/api_testing/category/read.php"; // can not print out results
        ...
        //response.log().all();
        Reporter.log("Categories of product got.");

    }
    @Test
    //Get one specific product, parameter is required.
   public void getProduct(){
        Reporter.log(" Test 2 - get all of products.");
